...
export const Brand = () => {
  return (
    <div>
      ...
      <div>
        <div className="max-w-screen-2xl md:flex md:justify-center flex-grid grid grid-cols-4 gap-8 pb-8 mx-auto">
        ...
        <div className="max-w-screen-2xl md:justify-center md:flex flex-grid grid grid-cols-4 gap-8 pb-8 mx-auto">
          <div className=" flex flex-col">
